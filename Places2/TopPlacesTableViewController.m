...
#import "FlickrPlacePicturesTableViewController.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FlickrPlacePicturesTableViewController * pvc = [[FlickrPlacePicturesTableViewController alloc] initInContext:self.managedObjectContext];
    NSDictionary * placeInfo = [self.topFlickrPlaces objectAtIndex:indexPath.row];
    pvc.placeName = [placeInfo objectForKey:@"_content"];
